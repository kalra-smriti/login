...
## Environments
- Preview: https://main--login--kalra-smriti.hlx.page/
- Live: https://main--login--kalra-smriti.hlx.live/
...
1. Open the `login` directory in your favorite IDE and start coding :)
